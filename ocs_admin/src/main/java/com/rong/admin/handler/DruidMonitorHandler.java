package com.rong.admin.handler;
...
public class DruidMonitorHandler extends Handler {
    ...
    public DruidMonitorHandler(String visitPath , IDruidStatViewAuth druidStatViewAuth) {
    ...
    class JFinalStatViewServlet extends StatViewServlet {
        ...
        public void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            if ("/submitLogin".equals(path)) {
                ...
                PropertiesUtils.load("/druid_monitor.properties");
                String pusername = PropertiesUtils.get("druid.username", "");
                String ppassword = PropertiesUtils.get("druid.password", "");
                if (pusername.equals(usernameParam) && ppassword.equals(passwordParam)) {
                    request.getSession().setAttribute(SESSION_USER_KEY, pusername);
