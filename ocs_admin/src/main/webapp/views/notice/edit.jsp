    ...
    <div class="tpl-block">
        <div class="am-g tpl-amazeui-form">
        	<div class="am-u-sm-12 am-u-md-9">
            	<form id="dataForm" action="<%=basePath%>/notice/edit" method="POST" class="am-form am-form-horizontal">
            	    <input type="hidden" name="id" value="${item.id }">
					<div class="am-form-group">
                        <label for="content" class="am-u-sm-3 am-form-label">公告内容</label>
                        <div class="am-u-sm-9">
                            <textarea  name="content" rows="10" >${item.content }</textarea>
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input class="am-form-field" type="text" value="${item.softwareCode }" name="softwareCode" required="required"/>
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                           <input class="am-form-field" type="text" value="${item.softwareName }" name="softwareName" required="required">
                        </div>
                    </div>
