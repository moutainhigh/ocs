    ...
    <div class="tpl-block">
        <div class="am-g tpl-amazeui-form">
        	<div class="am-u-sm-12 am-u-md-9">
            	<form id="dataForm" action="<%=basePath%>/userAuth/batchAdd" method="POST" class="am-form am-form-horizontal">
                    <div class="am-form-group">
		    			<label for="qqData" class="am-u-sm-3 am-form-label">录入格式&nbsp;&nbsp;<a href="javascript:$('#doc').modal('open');">格式说明</a></label>
		    			<div class="am-u-sm-9">
		    				<textarea  name="userNames" id="qqData" rows="10" ></textarea>
		    			</div>
					</div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input class="am-form-field" type="text" name="userPwd" required="required"/>
                        </div>
                    </div>
