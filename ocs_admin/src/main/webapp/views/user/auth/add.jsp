    ...
    <div class="tpl-block">
        <div class="am-g tpl-amazeui-form">
        	<div class="am-u-sm-12 am-u-md-9">
            	<form id="dataForm" action="<%=basePath%>/userAuth/save" method="POST" class="am-form am-form-horizontal">
                    <div class="am-form-group">
                        <label for="mealName" class="am-u-sm-3 am-form-label">软件key（用户api请求携带）</label>
                        <div class="am-u-sm-9">
                            <input class="am-form-field" type="text" name="authKey" required="required"/>
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                           <input class="am-form-field" type="text" name="authName" required="required">
                        </div>
                    </div>
