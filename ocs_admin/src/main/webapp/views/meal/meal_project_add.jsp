    ...
    <div class="tpl-block">
        <div class="am-g">
        	<div class="am-u-sm-12">
            	<form id="dataForm" role="form" action="<%=basePath %>/meal/saveMealProject" class="am-form">
  						...
  						<div class="am-panel-bd">
							...
							<div class="am-form-group">
								<div class="am-u-sm-10 am-u-sm-offset">
		  							...
		  							<input type="button" onclick="javascript:loadRight('${backUrl}')" class="am-btn am-btn-default" value="返回">
	  							</div>
  							</div>
  						</div>
					</div>
...
<SCRIPT type="text/javascript">
		...
		function getCheckNodeIds(){
			...
			for(var i=0;i<checkNodes.length;i++){
				if(i==0){
					checkNodeIds += checkNodes[i].id+"-"+checkNodes[i].name;
				}else{
					checkNodeIds += ","+checkNodes[i].id+"-"+checkNodes[i].name;
				}
			}
