    ...
    <div class="tpl-block">
        <div class="am-g tpl-amazeui-form">
        	<div class="am-u-sm-12 am-u-md-9">
            	<form id="dataForm" action="<%=basePath%>/meal/save" method="POST" class="am-form am-form-horizontal">
                    <div class="am-form-group">
                        <label for="mealName" class="am-u-sm-3 am-form-label">套餐名称</label>
                        <div class="am-u-sm-9">
                            <input class="am-form-field" type="text" name="mealName" required="required"/>
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                           <input class="am-form-field" type="number" name="mealTime" required="required">
                        </div>
                    </div>
