    ...
    <div class="tpl-block">
        <div class="am-g tpl-amazeui-form">
            <div class="am-u-sm-12 am-u-md-9">
                <form id="dataForm" action="<%=basePath%>/rechargeSet/save" method="POST" class="am-form am-form-horizontal">
                    <div class="am-form-group">
                        <label for="rechargeMoney" class="am-u-sm-3 am-form-label">充值金额</label>
                        <div class="am-u-sm-9">
                            <input class="am-form-field" type="text" name="rechargeMoney" maxlength="8" required="required">
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input class="am-form-field" type="text" name="give" maxlength="8" required="required"/>
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <textarea  name="remark" rows="10" maxlength="100"></textarea>
                        </div>
                    </div>
