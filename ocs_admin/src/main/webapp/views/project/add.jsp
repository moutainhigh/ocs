    ...
    <div class="tpl-block">
        <div class="am-g tpl-amazeui-form">
        	<div class="am-u-sm-12 am-u-md-9">
            	<form id="dataForm" action="<%=basePath%>/project/save" method="POST" class="am-form am-form-horizontal">
					<div class="am-form-group">
                        <label for="projectName" class="am-u-sm-3 am-form-label">项目名</label>
                        <div class="am-u-sm-9">
                            <input class="am-form-field" type="text" name="projectName" required="required">
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input class="am-form-field" type="text" name="price" min="1" max="10" required="required"/>
                        </div>
                    </div>
